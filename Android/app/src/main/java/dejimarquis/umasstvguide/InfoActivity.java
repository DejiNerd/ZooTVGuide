...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        information.setText("Hey you! Welcome to ZooTV. ZooTV is a TV guide for UMass Amherst. Search for a channel search bar. " +
                "\n\nMade with ❤️ by Deji, Timi, and Peter. The iOS app was developed and is maintained by Peter. " +
                "The Android app was developed and is maintained by Deji. Slide into our DMs if you have any questions, comments, or concerns. " +
